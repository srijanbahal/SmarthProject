    ...
    <div className="w-screen min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside
          ...
          } lg:w-80 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 overflow-y-auto transition-all duration-300 flex-shrink-0`}
        >
                  ...
                  <div
                    ...
                    dangerouslySetInnerHTML={{
                      __html: response.answer
                        .replace(/\*\*(.*?)\*\*/g, '<strong class="text-emerald-600 dark:text-emerald-400">$1</strong>')
                        .replace(/\n/g, "<br/>"),
                    }}
                  />
                </div>
